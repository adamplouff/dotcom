...
const config = {
  extensions: ['.svelte', '.md'],
    ...
    mdsvex(mdsvexOptions),
    {
        ...
        const transformedContent = content.replace(obsidianImageRegex, (_, p1) => {
        ...
        .replace(obsidianLinkRegex, (_, p1, p2, p3) => {
          ...
          const filePathArr = new fdir().glob(`./**/${slug}.md`).withRelativePaths().crawl('./src/adamplouff.com').sync();
